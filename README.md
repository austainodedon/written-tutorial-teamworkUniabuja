...
The link to the facebook open source code used as basis for this project is https://github.com/facebook/react
...
- Installation of MongoDB
   ...
   - Click on Try Free at the top right corner and you will get a confirmation email.
   - Sign in with your created account
   - Click on new project. In your project click on Build a cluster.
   - In your cluster, choose "aws" as your cloud provider.
   - Make sure you write a name for your project and click on create cluster.
   - After creating your cluster, you have to do some security settings such as adding new user name and password.
...
The content type is equal to application.json
...
```
{
  ...
  "version": "1.0.0",
  "description": "Social network for developers in the university of abuaja",
  "main": "server.js",
  "scripts": {
    "start": "node server",
...
**CLEAN UP AND INITIAL COMPONENT**
   ...
   - Go to the background and remove one dot (.) out of the two dots
   - Copy the showcase.jpg from theme and paste in the client, source folder. Make sure you create a folder called img inside the source folder before pasting the picturer
   - we're also going to be using font.
   - Go to fontawesome.com and click on the start using free. Copy the font link
   - Go to Public, index.html and paste the link.
   - Go to source and Create a nee folder called component, and in component, we create another folder called layout.
   - Inside the layout we would a file called Navbar.js and also create landing.js
   - in Navbar.js,   Type racf to automatically create our function component
   - Go to index.html, copy the Nav tag and paste it in Navbar.js
   - In landing.js  Type racf to automatically create our function component
...
<nav className="navbar bg-dark">
   <h1>
   <a href="index.html"><i classmate="fas fa-code"></i> DevConnector</a>
</h1>
<ul>
    <li><a href="profiles.html">Developers</a></li>
    <li><a href="register.html">Developers</a></li> 
      <li><a href="login.html">Developers</a></li>
</ul>
   </nav>
)
}
